...
/**
 * Transactions
 * Ledger entries — bao gồm thanh toán, hoàn tiền, credit nội bộ. Summary cards ở trên.
 *
...
export default function TransactionsPage() {
  return (
    <div className="px-16 py-12 max-w-5xl mx-auto">
      <p className="eyebrow mb-2">// stub · /me/transactions</p>
      <h1 className="display text-4xl mb-3">Transactions</h1>
      <p className="text-ink-2 mb-6 max-w-xl">Ledger entries — bao gồm thanh toán, hoàn tiền, credit nội bộ. Summary cards ở trên.</p>
...
Mở Hoisted.html → tìm artboard "Transactions" để copy markup.
