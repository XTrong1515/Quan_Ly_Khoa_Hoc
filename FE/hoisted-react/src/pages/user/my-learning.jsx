...
/**
 * MyLearning
 * Grid khóa đã mua + progress bar mỗi card + "Continue learning" highlight khóa đang học dở.
 *
...
export default function MyLearningPage() {
  return (
    <div className="px-16 py-12 max-w-5xl mx-auto">
      <p className="eyebrow mb-2">// stub · /me</p>
      <h1 className="display text-4xl mb-3">MyLearning</h1>
      <p className="text-ink-2 mb-6 max-w-xl">Grid khóa đã mua + progress bar mỗi card + "Continue learning" highlight khóa đang học dở.</p>
...
Mở Hoisted.html → tìm artboard "MyLearning" để copy markup.
