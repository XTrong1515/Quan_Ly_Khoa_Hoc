...
/**
 * ProfileSettings
 * Tabs: Thông tin cá nhân / Đổi mật khẩu / Avatar / 2FA / Email & thông báo / Phương thức thanh toán.
 *
...
export default function ProfileSettingsPage() {
  return (
    <div className="px-16 py-12 max-w-5xl mx-auto">
      <p className="eyebrow mb-2">// stub · /me/profile</p>
      <h1 className="display text-4xl mb-3">ProfileSettings</h1>
      <p className="text-ink-2 mb-6 max-w-xl">Tabs: Thông tin cá nhân / Đổi mật khẩu / Avatar / 2FA / Email & thông báo / Phương thức thanh toán.</p>
...
Mở Hoisted.html → tìm artboard "ProfileSettings" để copy markup.
