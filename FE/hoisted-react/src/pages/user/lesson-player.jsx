...
/**
 * LessonPlayer
 * ⭐ CRITICAL. Layout 2 cột 70/30. Trái: react-player + tabs (Overview / Attachments / Discussion / Code playground / Notes). Phải: sidebar curriculum accordion + nút "Mark as complete".
 *
...
export default function LessonPlayerPage() {
  return (
    <div className="px-16 py-12 max-w-5xl mx-auto">
      <p className="eyebrow mb-2">// stub · /learn/:courseId/:lessonId</p>
      <h1 className="display text-4xl mb-3">LessonPlayer</h1>
      <p className="text-ink-2 mb-6 max-w-xl">⭐ CRITICAL. Layout 2 cột 70/30. Trái: react-player + tabs (Overview / Attachments / Discussion / Code playground / Notes). Phải: sidebar curriculum accordion + nút "Mark as complete".</p>
...
Mở Hoisted.html → tìm artboard "LessonPlayer" để copy markup.
