...
/**
 * CourseDetail
 * Hero với thumb/preview, giá, CTA "Thêm vào giỏ"/"Mua ngay", tabs: Mô tả / Curriculum (accordion) / Reviews / Giảng viên, sticky sidebar.
 *
...
export default function CourseDetailPage() {
  return (
    <div className="px-16 py-12 max-w-5xl mx-auto">
      <p className="eyebrow mb-2">// stub · /courses/:id</p>
      <h1 className="display text-4xl mb-3">CourseDetail</h1>
      <p className="text-ink-2 mb-6 max-w-xl">Hero với thumb/preview, giá, CTA "Thêm vào giỏ"/"Mua ngay", tabs: Mô tả / Curriculum (accordion) / Reviews / Giảng viên, sticky sidebar.</p>
...
Mở Hoisted.html → tìm artboard "CourseDetail" để copy markup.
