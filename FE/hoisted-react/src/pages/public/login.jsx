...
/**
 * Login
 * Form login / register / forgot password. Split layout với marketing bên trái, form bên phải. Dùng react-hook-form + zod.
 *
...
export default function LoginPage() {
  return (
    <div className="px-16 py-12 max-w-5xl mx-auto">
      <p className="eyebrow mb-2">// stub · /login</p>
      <h1 className="display text-4xl mb-3">Login</h1>
      <p className="text-ink-2 mb-6 max-w-xl">Form login / register / forgot password. Split layout với marketing bên trái, form bên phải. Dùng react-hook-form + zod.</p>
...
Mở Hoisted.html → tìm artboard "Login" để copy markup.
