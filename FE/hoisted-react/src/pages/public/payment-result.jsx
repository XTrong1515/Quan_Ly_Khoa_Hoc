...
/**
 * PaymentResult
 * Success / failed screen sau khi VNPay redirect về. status truyền qua prop hoặc query param.
 *
...
export default function PaymentResultPage() {
  return (
    <div className="px-16 py-12 max-w-5xl mx-auto">
      <p className="eyebrow mb-2">// stub · /payment/:status</p>
      <h1 className="display text-4xl mb-3">PaymentResult</h1>
      <p className="text-ink-2 mb-6 max-w-xl">Success / failed screen sau khi VNPay redirect về. status truyền qua prop hoặc query param.</p>
...
Mở Hoisted.html → tìm artboard "PaymentResult" để copy markup.
