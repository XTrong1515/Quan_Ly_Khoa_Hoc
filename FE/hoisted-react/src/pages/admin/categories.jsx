...
/**
 * AdminCategories
 * CRUD đơn giản với drag-reorder. Edit panel bên phải khi chọn 1 category.
 *
...
export default function AdminCategoriesPage() {
  return (
    <div className="px-16 py-12 max-w-5xl mx-auto">
      <p className="eyebrow mb-2">// stub · /admin/categories</p>
      <h1 className="display text-4xl mb-3">AdminCategories</h1>
      <p className="text-ink-2 mb-6 max-w-xl">CRUD đơn giản với drag-reorder. Edit panel bên phải khi chọn 1 category.</p>
...
Mở Hoisted.html → tìm artboard "AdminCategories" để copy markup.
