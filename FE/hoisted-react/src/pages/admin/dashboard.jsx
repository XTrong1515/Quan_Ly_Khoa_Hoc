...
/**
 * AdminDashboard
 * Stat cards (Revenue, Users, Courses, Orders), LineChart doanh thu 30d (Recharts), BarChart top khóa học, funnel.
 *
...
export default function AdminDashboardPage() {
  return (
    <div className="px-16 py-12 max-w-5xl mx-auto">
      <p className="eyebrow mb-2">// stub · /admin</p>
      <h1 className="display text-4xl mb-3">AdminDashboard</h1>
      <p className="text-ink-2 mb-6 max-w-xl">Stat cards (Revenue, Users, Courses, Orders), LineChart doanh thu 30d (Recharts), BarChart top khóa học, funnel.</p>
...
Mở Hoisted.html → tìm artboard "AdminDashboard" để copy markup.
