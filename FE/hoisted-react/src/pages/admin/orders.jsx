...
/**
 * AdminOrders
 * Table order, filter chip theo status, action confirm/cancel pending. Realtime cập nhật mỗi 30s.
 *
...
export default function AdminOrdersPage() {
  return (
    <div className="px-16 py-12 max-w-5xl mx-auto">
      <p className="eyebrow mb-2">// stub · /admin/orders</p>
      <h1 className="display text-4xl mb-3">AdminOrders</h1>
      <p className="text-ink-2 mb-6 max-w-xl">Table order, filter chip theo status, action confirm/cancel pending. Realtime cập nhật mỗi 30s.</p>
...
Mở Hoisted.html → tìm artboard "AdminOrders" để copy markup.
