...
/**
 * AdminUsers
 * Table user, filter role/status, bulk actions (gửi email, đặt vai trò, lock).
 *
...
export default function AdminUsersPage() {
  return (
    <div className="px-16 py-12 max-w-5xl mx-auto">
      <p className="eyebrow mb-2">// stub · /admin/users</p>
      <h1 className="display text-4xl mb-3">AdminUsers</h1>
      <p className="text-ink-2 mb-6 max-w-xl">Table user, filter role/status, bulk actions (gửi email, đặt vai trò, lock).</p>
...
Mở Hoisted.html → tìm artboard "AdminUsers" để copy markup.
